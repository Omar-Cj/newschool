                                                    ...
                                                    <a href="{{ route('student.show', @$row->student->id) }}">
                                                        <div class="user-card">
                                                            <div class="user-avatar">
                                                                @if(@$row->student->upload)
                                                                    <img src="{{ asset(@$row->student->upload->path) }}"
                                                                        alt="{{ @$row->student->first_name }} {{ @$row->student->last_name }}"
                                                                        style="width: 32px; height: 32px; object-fit: cover; border-radius: 50%;">
                                                                @else
                                                                    {!! generateStudentAvatar(@$row->student->first_name, @$row->student->last_name, '32px') !!}
                                                                @endif
                                                            </div>
                                                            <div class="user-info">
                                                            ...
                                                            @if(isset($row->outstanding_amount) && $row->outstanding_amount > 0 && hasPermission('fees_collect_update'))
                                                                <li>
                                                                    <a class="dropdown-item" href="javascript:void(0);"
                                                                       ...
                                                                       onclick="openFeeCollectionModal({{ @$row->student->id }}, '{{ @$row->student->first_name }} {{ @$row->student->last_name }}')">
