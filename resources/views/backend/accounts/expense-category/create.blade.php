...
@section('content')
    <div class="page-content">
                ...
                <div class="col-sm-6">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item" aria-current="page"><a
                                href="{{ route('expense-category.index') }}">{{ ___('account.expense_categories') }}</a></li>
        ...
        <div class="card ot-card">
            <div class="card-body">
                <form action="{{ route('expense-category.store') }}" method="post" id="categoryForm">
                    @csrf
                    <div class="row mb-3">
                        <div class="col-lg-12">
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <select class="nice-select niceSelect bordered_style wide @error('status') is-invalid @enderror"
                                        ...
                                        <option value="1" {{ old('status') == 1 ? 'selected' : '' }}>{{ ___('common.active') }}</option>
