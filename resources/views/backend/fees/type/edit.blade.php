                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    name="academic_level" id="academic_level" aria-describedby="academic_level_feedback">
                                        <option value="all" {{ old('academic_level', @$data['fees_type']->academic_level) == 'all' ? 'selected' : '' }}>{{ ___('fees.all_levels') }}</option>
                                        <option value="kg" {{ old('academic_level', @$data['fees_type']->academic_level) == 'kg' ? 'selected' : '' }}>{{ ___('fees.kindergarten') }}</option>
                                        <option value="primary" {{ old('academic_level', @$data['fees_type']->academic_level) == 'primary' ? 'selected' : '' }}>{{ ___('fees.primary') }}</option>
                                        <option value="secondary" {{ old('academic_level', @$data['fees_type']->academic_level) == 'secondary' ? 'selected' : '' }}>{{ ___('fees.secondary') }}</option>
                                        <option value="high_school" {{ old('academic_level', @$data['fees_type']->academic_level) == 'high_school' ? 'selected' : '' }}>{{ ___('fees.high_school') }}</option>
                                    </select>
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    name="category" id="category" aria-describedby="category_feedback">
                                        <option value="academic" {{ old('category', @$data['fees_type']->category) == 'academic' ? 'selected' : '' }}>{{ ___('fees.academic') }}</option>
                                        <option value="transport" {{ old('category', @$data['fees_type']->category) == 'transport' ? 'selected' : '' }}>{{ ___('fees.transport') }}</option>
                                        <option value="meal" {{ old('category', @$data['fees_type']->category) == 'meal' ? 'selected' : '' }}>{{ ___('fees.meal') }}</option>
                                        <option value="accommodation" {{ old('category', @$data['fees_type']->category) == 'accommodation' ? 'selected' : '' }}>{{ ___('fees.accommodation') }}</option>
                                        <option value="activity" {{ old('category', @$data['fees_type']->category) == 'activity' ? 'selected' : '' }}>{{ ___('fees.activity') }}</option>
                                        <option value="other" {{ old('category', @$data['fees_type']->category) == 'other' ? 'selected' : '' }}>{{ ___('fees.other') }}</option>
                                    </select>
                                    @error('category')
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input class="form-control ot-input @error('amount') is-invalid @enderror" name="amount"
                                        ...
                                        placeholder="{{ ___('fees.enter_amount') }}" value="{{ old('amount', @$data['fees_type']->amount ?? 0) }}">
                                    @error('amount')
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input class="form-control ot-input @error('due_date_offset') is-invalid @enderror" name="due_date_offset"
                                        ...
                                        placeholder="{{ ___('fees.days_from_term_start') }}" value="{{ old('due_date_offset', @$data['fees_type']->due_date_offset ?? 30) }}">
                                ...
                                <div class="col-md-6 mb-3">
                                    <div class="form-check mt-4">
                                        <input class="form-check-input @error('is_mandatory_for_level') is-invalid @enderror" 
                                               ...
                                               id="is_mandatory_for_level" {{ old('is_mandatory_for_level', @$data['fees_type']->is_mandatory_for_level) ? 'checked' : '' }}>
