    ...
    <div class="page-content">
        ...
        <div class="col-12">
            <div class="card ot-card">
                ...
                <div class="card-body">
                    <form action="{{ route('journals.store') }}" method="post" id="journalForm" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            <!-- Journal Name -->
                            <div class="col-md-6">
                            ...
                            <div class="col-md-12">
                                <div class="single-input">
                                    ...
                                    <textarea class="form-control radius-md @error('description') is-invalid @enderror"
                                              name="description"
                                              rows="4"
                                              placeholder="{{ ___('journals.enter_description') }}">{{ old('description') }}</textarea>
                                    @error('description')
                                        <div id="validationServer04Feedback" class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                                ...
                                <div class="single-input">
                                    <div class="d-flex justify-content-end gap-3">
                                        ...
                                        <button type="submit" class="btn btn-lg ot-btn-primary radius-md">
                                            ...
                                            <span class=""> {{ ___('common.save') }}</span>
                                        </button>
                                    </div>
                                </div>
                            </div>
